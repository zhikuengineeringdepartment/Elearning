...
cid:112 //int 课程号，可不传，建议传
vid:V1.0 //string 课程版本号，可不传，受数据库结构影响，建议传
```
**RequestMethod:** GET
**ResponseBody：**
...
```json
{
	...
	"seqs": "二维int数组，指定课程内容的章节序号，如[[1,1][2,3]]表示内容包含两节，第1章第1节，第2章第3节，可不传，默认从第1章第1节顺序"
}
```
**RequestMethod:** POST
**ResponseBody:**
...
```json
{
	...
	"seqs": "二维int数组，指定要删除的章节序号，如[[1,1][2,3]]表示内容包含两节，第1章第1节，第2章第3节，可不传，默认全删"
}
```
**RequestMethod:** POST
**ResponseBody:**
