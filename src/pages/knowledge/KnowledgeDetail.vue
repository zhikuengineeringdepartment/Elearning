    ...
    <!--<el-row type="flex" class="row-bg" justify="center">-->
      <!--<el-col :span="4">-->
        ...
        <!--<el-menu-->
          ...
          <!--&lt;!&ndash;<template v-for="section in courseView.sections">&ndash;&gt;-->
          <!--&lt;!&ndash;<el-menu-item :index="section.sid.toString()" @click="handleMenu(section.sid)">&ndash;&gt;-->
          <!--&lt;!&ndash;<i class="el-icon-arrow-right"></i>&ndash;&gt;-->
          <!--&lt;!&ndash;<span slot="title">{{section.sectionName.substring(section.sectionName.indexOf(' '))}}</span>&ndash;&gt;-->
          <!--&lt;!&ndash;</el-menu-item>&ndash;&gt;-->
          <!--&lt;!&ndash;</template>&ndash;&gt;-->
          <!--<div v-for="zhang in courseView.sections">-->
      ...
      <!--<el-col :span="12" style="margin: 20px">-->
        <!--<div style="display: flex;justify-content: space-between">-->
          ...
          <!--</div>-->
        <!--</div>-->
        <!--&lt;!&ndash;<my_section :sectionView="sectionView" :noteViews="noteViews" :colParas="colParas"></my_section>&ndash;&gt;-->
        <!--<div style="display: flex;justify-content: space-between">-->
          <!--<div>-->
        ...
        <!--</div>-->
        <!--<h3>相关csdn推荐</h3>-->
        <!--<div v-for="item in csdn">-->
          <!--<a target="_blank" :href="item.url" class="recommendtion">{{item.title}}</a>-->
        <!--</div>-->
      <!--</el-col>-->
    <!--</el-row>-->
  <!--</el-main>-->
