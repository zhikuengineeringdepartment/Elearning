  ...
  export default {
    ...
    methods: {
      ...
      getCourseView: function (cid) {
        ...
        this.$http.get('course/getCourseDetails', {
          params: {
            cid: cid
          }
        })
            ...
            if (response.data.code === 200) {
              ...
              for (let i = 0; i < tempSections.length; i++) {
                ...
                if (name.substring(0, name.indexOf(' ')) === '#') {
                  ...
                  sections[index] = {};
                  sections[index].title = name.substring(name.indexOf(' '), name.indexOf('章') + 1);
                  sections[index].index = index;
                  sections[index].sub = [];
                  sections[index].sub[0] = tempSections[i];
                } else {
                  sections[index].sub[sections[index].sub.length] = tempSections[i];
                }
              }
      ...
      getSectionView: function (sid) {
        ...
        this.$http.get('section/getSection', {
          params: {
            sid: sid
          }
        })
          .then(function (response) {
            ...
            if (response.data.code === 200) {
              ...
              _this.sectionView.sectionNameHtml = converter.makeHtml(_this.sectionView.sectionName.toString());
      ...
      //   let _this = this;
      //   this.$http.post('paragraph/getNoteBySid', {
      //     uid: 0,
      //     sid: sid
      //   }, {
      //     transformRequest: [
      ...
      //   let _this = this;
      //   this.$http.post('paragraph/getColParagraphBySid', {
      //     uid: 0,
      //     sid: sid
      //   }, {
      //     transformRequest: [
