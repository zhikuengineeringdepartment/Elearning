<template>
  <div class="section">
    ...
    <div v-for="knowledge in sectionView.knowledgeViews" :key="knowledge.kid">
      <div class="knowledge-name" v-html="knowledge.knowledgeNameHtml"></div>
      <div v-for="paragraph in knowledge.paragraphs" :key="paragraph.pid">
        <div class="paragraph" @mouseover="currentPid = paragraph.pid" @mouseout="currentPid = -1">
          <div class="paragraph-content" v-html="paragraph.paragraphContentHtml"></div>
          <!--<div v-if="currentPid === paragraph.pid">-->
            <!--<div class="button-group">-->
              <!--<div class="button">收藏</div>-->
              <!--<div class="button">笔记</div>-->
            <!--</div>-->
          <!--</div>-->
        </div>
      </div>
